...
WebUI.verifyElementClickable(findTestObject('Leads Page/Page_Shortlyst_Project/a_Projects'))

WebUI.click(findTestObject('Leads Page/Page_Shortlyst_Project/a_Projects'))
